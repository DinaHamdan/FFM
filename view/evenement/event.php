<main>
    <section id="convention">
        ...
        <h2 id="convention-info"><?= $args['convention']['cost'] ?></h2>
        ...
        <div id="convention-poster-container">
            ...
            <img src=" data:image/png;base64,<?= base64_encode($args['convention']['poster']) ?>" alt="photo-poster">
            <img src=" data:image/png;base64,<?= base64_encode($args['convention']['programPhoto']) ?>" alt="photo-program">
        </div>
        <div id="convention-description-container">
            <img id="convention-photo" src="../../asset/img/convention-photo.avif" alt="">
            <p id="convention-description"> <?= $args['convention']['description'] ?></p>
        </div>
        ...
        <div id="convention-content">
            ...
            <div class="convention-content-container">
                <h3><?= $args['convention']['firstDate'] ?></h3>
                <p> <?= $args['convention']['firstDateContent'] ?></p>
            </div>
            <div class="convention-content-container">
                <h3><?= $args['convention']['secondDate'] ?></h3>

                <p>
                    <?= $args['convention']['secondDateContent'] ?></p>
            </div>
            <div class="convention-content-container">
                <h3><?= $args['convention']['thirdDate'] ?></h3>
                <p> <?= $args['convention']['thirdDateContent'] ?></p>
            </div>
