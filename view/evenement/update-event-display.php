<main>
    <section id="update-event-section">
        ...
        <form id="update-event-form" action="/evenement/update-event" method="post" enctype="multipart/form-data">
            ...
            <textarea id="conventionCost" name="conventionCost"><?= $args['convention']['cost'] ?></textarea>


            <label for="conventionFirstDay">Modifier Date 1</label>
            <input type="text" id="conventionFirstDay" name="conventionFirstDay" value="<?= $args['convention']['firstDate'] ?>">

            <label for="contentFirstDay">Modifier Contenu date 1 </label>
            <textarea id="contentFirstDay" name="contentFirstDay"><?= $args['convention']['firstDateContent'] ?></textarea>

            <label for="conventionSecondDay">Modifier Date 2</label>
            <input type="text" id="conventionSecondDay" name="conventionSecondDay" value="<?= $args['convention']['secondDate'] ?>">


            <label for="contentSecondDay">Modifier Contenu date 2 </label>
            <textarea id="contentSecondDay" name="contentSecondDay"><?= $args['convention']['secondDateContent'] ?></textarea>

            <label for="conventionThirdDay">Modifier Date 3</label>
            <input type="text" id="conventionThirdDay" name="conventionThirdDay" value="<?= $args['convention']['thirdDate'] ?>">

            <label for="contentThirdDay">Modifier Contenu date 3 </label>
            <textarea id="contentThirdDay" name="contentThirdDay"><?= $args['convention']['thirdDateContent'] ?></textarea>

            <label for="conventionDescription">Modifier description</label>
            <textarea id="conventionDescription" name="conventionDescription"><?= $args['convention']['description'] ?></textarea>
            <label for="address">Modifier Adresse</label>
            <textarea id="address" name="address"><?= $args['convention']['address'] ?></textarea>
